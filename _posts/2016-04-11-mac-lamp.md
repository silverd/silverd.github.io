...
## 可选安装 PHP7-PECL-YAF 扩展（homwbrew 里已可以安装 php70-yaf，但版本可能不是最新）
...
## 或者直接设置命令别名 vi ~/.zshrc，加入：
    ...
    alias nginx.start="sudo launchctl load -w /Library/LaunchDaemon/homebrew.mxcl.nginx.plist"
    alias nginx.stop="sudo launchctl unload -w /Library/LaunchDaemon/homebrew.mxcl.nginx.plist"
    alias nginx.restart='nginx.stop && nginx.start'

    alias php.start="sudo launchctl load -w /Library/LaunchDaemon/homebrew.mxcl.php70.plist"
    alias php.stop="sudo launchctl unload -w /Library/LaunchDaemon/homebrew.mxcl.php70.plist"
    alias php.restart='php.stop && php.start'

    alias mysql.start="sudo launchctl load -w /Library/LaunchDaemon/homebrew.mxcl.mysql.plist"
    alias mysql.stop="sudo launchctl unload -w /Library/LaunchDaemon/homebrew.mxcl.mysql.plist"
    alias mysql.restart='mysql.stop && mysql.start'

    alias redis.start="sudo launchctl load -w /Library/LaunchDaemon/homebrew.mxcl.redis.plist"
    alias redis.stop="sudo launchctl unload -w /Library/LaunchDaemon/homebrew.mxcl.redis.plist"
    alias redis.restart='redis.stop && redis.start'

    alias memcached.start="sudo launchctl load -w /Library/LaunchDaemon/homebrew.mxcl.memcached.plist"
    alias memcached.stop="sudo launchctl unload -w /Library/LaunchDaemon/homebrew.mxcl.memcached.plist"
