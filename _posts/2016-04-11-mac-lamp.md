...
可以通过直接在命令行运行：
    ...
    curl -o install_mac_dev_env.sh https://raw.githubusercontent.com/silverd/silverd.github.io/master/res/attach/install_mac_dev_env.sh
    chmod +x install_mac_dev_env.sh
    sh install_mac_dev_env.sh
